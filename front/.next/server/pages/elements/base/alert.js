...
module.exports = __webpack_require__("GGp8");
...
class AlertPage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("title", null, "Alert | Panely")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Container */ "u"], {
      fluid: true
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Basic")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, __jsx("strong", null, "Alerts"), " are available for any length of text, as well as an optional dismiss button. For proper styling, use one of the eight", " ", __jsx("strong", null, "required"), " contextual classes"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Row */ "S"], null, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Col */ "s"], {
      md: "4"
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"], null, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Header, {
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Solid")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, "Use ", __jsx("code", null, "variant"), " property to apply contextual colors"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "primary"
    }, "Primary"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "secondary"
    }, "Secondary"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "info"
    }, "Info"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "warning"
    }, "Warning"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "danger"
    }, "Danger"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "success"
    }, "Success"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "dark"
    }, "Dark"), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "light",
      className: "mb-0"
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Links")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, "Use the ", __jsx("code", null, "Alert.Link"), " component to quickly provide matching colored links within any alert."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "primary"
    }, "A simple alert with ", __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Link, {
      href: "#"
    }, "an example link"), ". Give it a click if you like."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "outline-secondary"
    }, "A simple alert with ", __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Link, {
      href: "#"
    }, "an example link"), ". Give it a click if you like."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      ...
      href: "#"
    }, "an example link"), ". Give it a click if you like."))), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"], null, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Header, {
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Additional content")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, "Alerts can also contain additional HTML elements like headings, paragraphs and dividers."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "success"
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Header, null, "Well done!"), __jsx("p", {
      className: "mb-0"
    }, "Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "outline-success",
      className: "mb-0"
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Header, null, "Well done!"), __jsx("p", null, "Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content."), __jsx("hr", null), __jsx("p", {
      className: "mb-0"
    }, "Whenever you need to, be sure to use margin utilities to keep things nice and tidy."))))), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Col */ "s"], {
      md: "6"
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"], null, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Header, {
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Icon")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, "If you want to put icon into alert element, you can use ", __jsx("code", null, "icon"), " ", "property and fill it with your icon."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "primary",
    ...
    }, "A simple primary alert with ", __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Link, {
      href: "#"
    }, "an example link"), ". Give it a click if you like."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      variant: "outline-secondary",
      icon: __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__["FontAwesomeIcon"], {
      ...
      bordered: true
    }, __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Title, null, "Dismissible alert")), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Portlet */ "P"].Body, null, __jsx("p", null, "It\u2019s possible to dismiss any alert inline. For the most basic use-case an uncontrolled component can provide the functionality wanted without the need to manage/control the state of the component. ", __jsx("code", null, "Alert.Uncontrolled"), " does not require ", __jsx("code", null, "isOpen"), " nor ", __jsx("code", null, "toggle"), " props to work."), __jsx(AlertControlled, null), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Uncontrolled, {
      fade: true,
      variant: "outline-warning"
    }, "Holy guacamole! You should check in on some of those fields below."), __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"].Uncontrolled, {
      fade: true,
      variant: "label-secondary",
      className: "mb-0",
      icon: __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__["FontAwesomeIcon"], {
...
class AlertControlled extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    return __jsx(_panely_components__WEBPACK_IMPORTED_MODULE_1__[/* Alert */ "b"], {
      isOpen: this.state.isOpen,
      toggle: this.toggle,
      variant: "success",
      icon: __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__["FontAwesomeIcon"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["connect"])(null, mapDispathToProps)(Object(components_layout_withLayout__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(AlertPage)));
